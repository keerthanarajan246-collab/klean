...
try {
    ...
    if ($courseCount == 0) {
        ...
        VALUES
        (1, 2, 1, 'Complete Web Development Bootcamp', 'HTML CSS JS React Node MongoDB', 'Master HTML, CSS, JavaScript, Node, React and build beautifully functional products from scratch. Build a stellar developer portfolio and get ready to land your dream junior developer job. We start from absolute zero experience.', 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=400&q=80', 'beginner', 1499.00, 599.00, 'published', 52.0, 10, 4.70, 12400, 125000, 1, NOW()),
        (2, 2, 1, 'Python for Data Science & ML', 'NumPy Pandas Matplotlib Scikit-learn', 'From Zero to Hero — master Python, Pandas, and train real Machine Learning pipelines. This complete learning path contains everything you need to kickstart your career in Data Science.', 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=400&q=80', 'intermediate', 1999.00, 699.00, 'published', 40.0, 6, 4.80, 9800, 98000, 1, NOW()),
        (3, 2, 2, 'UI/UX Design Masterclass', 'Figma Adobe XD Prototyping User Research', 'Learn wireframes, Figma glassmorphism styles, and build sleek interactive prototypes that wow clients. You will learn user testing, accessibility standards, and professional design hands-on.', 'https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?auto=format&fit=crop&w=400&q=80', 'beginner', 1299.00, 499.00, 'published', 28.0, 5, 4.60, 6200, 74000, 0, NOW()),
        (4, 2, 4, 'Digital Marketing Full Course', 'SEO SEM Social Media Email Marketing', 'SEO, SEM, Copywriting, Social Campaigns — master strategies that convert views into revenue. Includes step-by-step instructions on running automated email newsletter funnels.', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=400&q=80', 'beginner', 1099.00, 399.00, 'published', 22.0, 5, 4.50, 5100, 61000, 0, NOW()),
        (5, 2, 1, 'React JS Complete Guide', 'Hooks Redux Context API Next.js', 'Build responsive, high-performance web applications using React Hooks, Redux Toolkit, Context API, and Next.js framework. Includes modular component architectures and cloud deployments.', 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?auto=format&fit=crop&w=400&q=80', 'intermediate', 1499.00, 599.00, 'published', 35.0, 6, 4.90, 11200, 112000, 1, NOW()),
        (6, 2, 5, 'Photography Masterclass', 'DSLR Composition Lightroom Editing', 'Master camera exposure, lighting, framing, and Lightroom editing configurations. Learn creative studio lighting systems and professional photo retouching step-by-step.', 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=400&q=80', 'beginner', 999.00, 349.00, 'published', 18.0, 4, 4.40, 3800, 42000, 0, NOW()),
        (7, 2, 7, 'Financial Planning & Investing', 'Stocks Bonds ETFs Retirement Planning', 'Index funds, crypto analysis, tax structures, and portfolio balancing methods. Learn how to grow your wealth steadily through calculated, compound-interest investment vehicles.', 'https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&w=400&q=80', 'beginner', 1199.00, 449.00, 'published', 15.0, 4, 4.70, 4900, 53000, 0, NOW()),
        (8, 2, 2, 'Graphic Design Bootcamp', 'Photoshop Illustrator InDesign Canva', 'Typography, brand logos, vector assets, and design mockups with Adobe Creative Suite. Build print-ready designs, packaging concepts, and high-fidelity promotional mockups.', 'https://images.unsplash.com/photo-1626785774573-4b799315345d?auto=format&fit=crop&w=400&q=80', 'beginner', 1099.00, 399.00, 'published', 24.0, 5, 4.60, 5600, 67000, 0, NOW())");
    }
